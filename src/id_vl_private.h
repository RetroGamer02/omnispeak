 ...
 */
#define VL_VGA_GFX_SHRUNK_LEFTBORDER_WIDTH 40 //(VL_VGA_GFX_SCALED_LEFTBORDER_WIDTH / VL_VGA_GFX_WIDTH_SCALEFACTOR)
#define VL_VGA_GFX_SHRUNK_RIGHTBORDER_WIDTH 40 //(VL_VGA_GFX_SCALED_RIGHTBORDER_WIDTH / VL_VGA_GFX_WIDTH_SCALEFACTOR)
#define VL_VGA_GFX_SHRUNK_TOPBORDER_HEIGHT 20 //(VL_VGA_GFX_SCALED_TOPBORDER_HEIGHT / VL_VGA_GFX_HEIGHT_SCALEFACTOR)
#define VL_VGA_GFX_SHRUNK_BOTTOMBORDER_HEIGHT 20 //(VL_VGA_GFX_SCALED_BOTTOMBORDER_HEIGHT / VL_VGA_GFX_HEIGHT_SCALEFACTOR)

#define VL_VGA_GFX_SCALED_WIDTH_PLUS_BORDER 320 //(VL_VGA_GFX_WIDTH_SCALEFACTOR * VL_EGAVGA_GFX_WIDTH + VL_VGA_GFX_SCALED_LEFTBORDER_WIDTH + VL_VGA_GFX_SCALED_RIGHTBORDER_WIDTH)
#define VL_VGA_GFX_SCALED_HEIGHT_PLUS_BORDER 200 //(VL_VGA_GFX_HEIGHT_SCALEFACTOR * VL_EGAVGA_GFX_HEIGHT + VL_VGA_GFX_SCALED_TOPBORDER_HEIGHT + VL_VGA_GFX_SCALED_BOTTOMBORDER_HEIGHT)
#define VL_VGA_GFX_SHRUNK_WIDTH_PLUS_BORDER 400 //(VL_EGAVGA_GFX_WIDTH + VL_VGA_GFX_SHRUNK_LEFTBORDER_WIDTH + VL_VGA_GFX_SHRUNK_RIGHTBORDER_WIDTH)
#define VL_VGA_GFX_SHRUNK_HEIGHT_PLUS_BORDER 240 //(VL_EGAVGA_GFX_HEIGHT + VL_VGA_GFX_SHRUNK_TOPBORDER_HEIGHT + VL_VGA_GFX_SHRUNK_BOTTOMBORDER_HEIGHT)
